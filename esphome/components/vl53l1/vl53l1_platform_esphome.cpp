...
extern "C" int8_t VL53L1_RdByte(uint16_t dev, uint16_t index, uint8_t *pdata) {
  return VL53L1_ReadMulti(dev, index, pdata, 1);
}

extern "C" int8_t VL53L1_RdWord(uint16_t dev, uint16_t index, uint16_t *pdata) {
  uint8_t buf[2] = {0};
...
extern "C" int8_t VL53L1_RdDWord(uint16_t dev, uint16_t index, uint32_t *pdata) {
  uint8_t buf[4] = {0};
